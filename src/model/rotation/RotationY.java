...
{	
	...
	public void rotate(Cube cube, int direction, int index)
	{
		if(index == 0)
		{
			switch (direction) 
			{
	            case UP :  new RotationSquare().rotate(cube.getSquare(Cube.LEFT), Rotation.COUNTERCLOCKWISE); break;
	            case DOWN: new RotationSquare().rotate(cube.getSquare(Cube.LEFT), Rotation.CLOCKWISE); break;
	            default: break;
			}
        }
		else if(index == cube.getSize() - 1)
		{
			switch (direction) 
			{
	            case UP :  new RotationSquare().rotate(cube.getSquare(Cube.RIGHT), Rotation.CLOCKWISE); break;
	            case DOWN: new RotationSquare().rotate(cube.getSquare(Cube.RIGHT), Rotation.COUNTERCLOCKWISE); break;
	            default: break;
			}
		}
		switch (direction) 
