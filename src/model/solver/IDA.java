...
{	
	...
	public void solve(Cube cube) 
	{
		...
		*/
		...
		System.out.println(population.getBestAI().getFitness() + " ");

			this.solution = population.getBestAI().getRotations();
			for(int i = 0; i < this.solution.size(); i++)
			{
					System.out.print((this.solution.get(i)[0] + 1) + " " + (this.solution.get(i)[1] + 1) + " ");
					cube.rotate(this.solution.get(i));
					System.out.println();
			}
